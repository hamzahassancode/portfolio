      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-semibold gradient-text">Hamza Hassan</span>
            </div>
            ...
            <nav className="flex flex-col gap-2">
              {NAV_LINKS.map(({ label, to }) => (
                <Link
                  key={to}
                  to={to}
                  className="text-sm text-gray-500 hover:text-gray-300 transition-colors w-fit"
                >
                  {label}
                </Link>
              ))}
          ...
          {/* Social */}
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-widest text-gray-500 mb-4">Connect</h3>
            <div className="flex flex-col gap-2">
              <a
                href="https://github.com"
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 text-sm text-gray-500 hover:text-gray-300 transition-colors group w-fit"
              >
        ...
        <div className="border-t border-dark-700/40 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-sm text-gray-600">
            © {new Date().getFullYear()} Hamza Hassan. All rights reserved.
          </p>
